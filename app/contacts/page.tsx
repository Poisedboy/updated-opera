...
const metadata: Metadata = {
    title: 'Контакти',
    description: 'Контактні дані апартготелю Опера Пасаж. Телефони, інстаграм, електронна пошта.'
}
...
const Contacts = () => {
    return (
        <>
            <Card className="m-10">
                <CardTitle className="p-5 text-center">Ми завжди онлайн</CardTitle>
                <hr></hr>
            ...
            <CardTitle className="text-center mb-10">проспект Свободи 27, Львів, Львівська область, 79000</CardTitle>
